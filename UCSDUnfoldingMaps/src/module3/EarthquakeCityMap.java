...
public class EarthquakeCityMap extends PApplet {
	...
	*/
	...
	{  
		...
		Object magObj_1 = feature.getProperty("magnitude");
		float mag = Float.parseFloat(magObj_1.toString());
		
	    // Here is an example of how to use Processing's color method to generate 
	    // an int that represents different colors.  
	    int green= color(38, 252, 22);
	    ...
	    //Adding colors to markers based on the magnitude of the earthquakes
	    	Object magObj_2 = feature.getProperty("magnitude");
	    	float magnit = Float.parseFloat(magObj_2.toString());
	    	if (  magnit <  4 ) {
